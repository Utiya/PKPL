...
settings_button = driver.find_element(By.CLASS_NAME, "nav-action.link.has-popover.settings")
settings_button.click()
time.sleep(2)
#navigasi ke menu logout
logout_save = driver.find_element(By.ID, "btn-link.logout")
logout_save.click()
time.sleep(5)
